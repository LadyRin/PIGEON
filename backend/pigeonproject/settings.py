"""
Django settings for pigeonproject project.
...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-uk71!olo1z6%pf5m_)qr4+=wjuy3t%^3=#7=715kriteoi@-p5')
...
MEDIA_ROOT = os.path.expanduser('~/Documents')
MEDIA_URL = '/media/'
...
ROOT_URLCONF = "pigeonproject.urls"
...
WSGI_APPLICATION = "pigeonproject.wsgi.application"

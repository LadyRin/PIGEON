    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('speaker_first_name', models.CharField(blank=True, max_length=100)),
                ('speaker_last_name', models.CharField(blank=True, max_length=100)),
                ('speaker_from', models.CharField(blank=True, max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mail_to', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pigeonwebapp.mailinglist')),
            ],
        ),
    ]
